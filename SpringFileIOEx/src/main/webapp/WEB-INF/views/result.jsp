...
<body>
	<h1>업로드가 완료되었습니다.</h1>
	<%-- 	
	<label>아이디:</label><input type="text" name="id" value="${map.id }" readonly><br>
	<label>이름:</label><input type="text" name="name" value="${map.name }" readonly><br>
	...
	<div class="result-images">
		<c:forEach var="imageFileName" items="${ map.fileList}">
			...
			<img src="${pageContext.request.contextPath }/download?imageFileName=${imageFileName }"> <br><br><br>
		</c:forEach>
	</div>
	<p>
